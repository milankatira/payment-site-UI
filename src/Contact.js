...
const Contact = () => {
  ...
  const submitData = async (event) => {
    ...
    if (firstName && lastName && phone && email && address && message) {
      const res = fetch(
        "https://paytm-ac7a2-default-rtdb.firebaseio.com/userdata.json",
        {
          method: "POST",
          headers: {
                  ...
                  <form method="POST">
                    ...
                    <div class="form-check form-checkbox-style">
                      ...
                      <label
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores repellendus exercitationem a, voluptatum voluptates numquam.
                      </label>
                    </div>
